...
/**
 * A Classe usuário é responsavel por gerenciar todas as operações relacionadas a usuários.
 */
class Usuario {
  /**
  ...
  /**
   * @throws {InvalidArgumentError} - Esse ocorre quando um usuário com o mesmo e-mail já esta cadastrado.
   */
  async adiciona () {
